...
use crate::util::http_post_json;

plugin_settings!(SetuPluginSettings,
        "色图","一个",true,SetuPluginConfig {
            recall_time:i32 => 60,
            whether_to_save_locally:bool => false
        }
    );
